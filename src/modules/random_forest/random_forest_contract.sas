/* =========================================================================
random_forest_contract.sas - Validaciones de entrada para RF Challenge
========================================================================= */

%include "&fw_root./src/modules/challenge/challenge_contract.sas";

%macro random_forest_contract(input_caslib=PROC, train_table=_train_input,
