/* =========================================================================
random_forest_report.sas - Reportes ODS para RF Challenge (METOD9)
========================================================================= */
...
%macro _random_forest_report(benchmark_data=, eval_data=, topk_data=, topn_data=,
    ...
    proc report data=&eval_data. nowd missing;
        columns Iteration GiniCoefficient NTREE M BOOTSTRAP NBINS MAXLEVEL
            LEAFSIZE;
        ...
        define BOOTSTRAP / display "InBag";
    ...
    proc report data=&topk_data. nowd missing;
        columns Model_Rank Gini_Train Gini_OOT Gini_Penalizado NTREE M
            BOOTSTRAP NBINS MAXLEVEL LEAFSIZE MAXBRANCH MISSING BINMETHOD GROW;
