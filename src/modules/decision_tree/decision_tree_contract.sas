/* =========================================================================
decision_tree_contract.sas - Validaciones de entrada para DT Challenge
========================================================================= */

%include "&fw_root./src/modules/challenge/challenge_contract.sas";

%macro decision_tree_contract(input_caslib=PROC, train_table=_train_input,
