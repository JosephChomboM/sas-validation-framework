/* =========================================================================
gradient_boosting_report.sas - Reportes ODS para GB Challenge (METOD9)
========================================================================= */
...
%macro _gradient_boosting_report(benchmark_data=, eval_data=, topk_data=, topn_data=,
    ...
    quit;
%mend _gradient_boosting_report;
