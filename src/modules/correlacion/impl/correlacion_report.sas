...
Lee las tablas de casuser (CAS) generadas por correlacion_compute:
casuser._corr_pearson
casuser._corr_spearman
...
%macro _correlacion_report(report_path=, file_prefix=);
  ...
  proc format;
    value CorrSignif -0.5 -< 0.0="lightgreen" 0.0 -< 0.5="lightgreen" -0.6
      -<-0.5="yellow" 0.5 -< 0.6="yellow" low -<-0.6="red" 0.6 - high="red" ;
  run;
