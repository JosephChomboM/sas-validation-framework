...
data casuser.cfg_troncales;
	...
	num_unv=
		"prod_antmax_per_prm_u12 FATC_MTO_INT_TC_ING_U3M can_ctd_tmo_CF_prm_u12 INGRESO_BCI prod_antmax_cvi_prm_u12";
	cat_unv="";
	dri_num_unv="";
	dri_cat_unv="";
	...
	num_unv=
		"prod_antmax_per_prm_u12 FATC_MTO_INT_TC_ING_U3M can_ctd_tmo_CF_prm_u12 prod_mto_sld_prm_pas_max_6 prod_mto_sld_fim_pas_max_8 prod_antmin_tot_prm_u9m fatc_mto_int_ccl_frq_u3m pllchf_ctd_pas_pr12r";
	cat_unv="";
	dri_num_unv="";
	dri_cat_unv="";
...
data casuser.cfg_segmentos;
	...
	seg_id=1;
	num_list=
		"prod_antmax_per_prm_u12 FATC_MTO_INT_TC_ING_U3M can_ctd_tmo_CF_prm_u12";
		/* vacío => hereda num_unv del troncal */
	cat_list="";
	...
	seg_id=2;
	num_list=
		"fatc_pct_pag_med_ctamin_u3 can_ctd_tmo_CF_prm_u12 prod_mto_sld_prm_tsav_frq7 INGRESO_BCI";
	cat_list="";
	...
	seg_id=3;
	num_list=
		"fatc_pct_pag_med_ctamin_u3 can_ctd_tmo_CF_prm_u12 prod_mto_sld_prm_tsav_frq7 INGRESO_BCI prod_antmax_cvi_prm_u12";
	cat_list="";
	...
	seg_id=2;
	num_list=
		"prod_mto_sld_prm_pas_max_6 prod_mto_sld_fim_pas_max_8 prod_antmin_tot_prm_u9m fatc_mto_int_ccl_frq_u3m pllchf_ctd_pas_pr12r";
	cat_list="";
	dri_num_list="";
	dri_cat_list="";
	output;
