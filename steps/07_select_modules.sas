...
/* ========= Método 9 - Challenge ======================================= */
%let _run_challenge_ui=%sysfunc(coalescec(%superq(_id_run_challenge), 0));
...
%let run_challenge=%sysfunc(max(&_run_challenge_ui., &run_gradient_boosting.,
    &run_random_forest.));
...
%put NOTE: 9.0 → challenge=&run_challenge. (ui=&_run_challenge_ui.)
